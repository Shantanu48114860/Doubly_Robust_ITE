...
# pyplot.draw()
# pyplot.savefig("Plots/Jobs_Hist_y_f.jpeg", dpi=220)
# pyplot.clf()
...
# plt.grid(True)
plt.scatter(diff_yf_DR_Prob, diff_yf_DR_Prob_wo_DR, c='#AED6F1', alpha=1)
# plt.scatter(grades_range, diff_yf_DR_Prob_wo_DR, c='red', alpha=0.5)
# plt.show()
plt.xticks(fontsize=7)
plt.yticks(fontsize=7)
plt.draw()
plt.savefig("Plots/Jobs_scatter_y_f.jpeg", dpi=220)
plt.clf()
