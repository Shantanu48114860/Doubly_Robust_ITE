class Constants:
    ...
    Encoder_x_shared_nodes = 100
    Encoder_t_shared_nodes = 100
    Encoder_yf_shared_nodes = 100
    Encoder_ycf_shared_nodes = 100
    ...
    Info_GAN_Gen_in_nodes = Decoder_in_nodes + 100
    Info_GAN_Gen_shared_nodes = 100
    Info_GAN_Gen_out_nodes = 1

    # 25 -> covariates, 1 -> y0, 1-> y1
    Info_GAN_Dis_in_nodes = DRNET_INPUT_NODES + 2
    Info_GAN_Dis_shared_nodes = 100
